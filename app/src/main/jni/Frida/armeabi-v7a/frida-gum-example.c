 ...
 * Compile with:
 *
 * /Users/frida/Buildbot/frida-android/build/build/ndk-android-arm/bin/arm-linux-androideabi-clang -fPIC -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -DANDROID -ffunction-sections -fdata-sections -Wall -Os -pipe -g3 -mthumb frida-gum-example.c -o frida-gum-example -L. -lfrida-gum -llog -ldl -fuse-ld=gold -Wl,--fix-cortex-a8,--icf=safe,--gc-sections,-z,noexecstack,-z,relro,-z,now -L/Users/frida/Buildbot/frida-android/build/build/frida-android-arm/lib -L/Users/frida/Buildbot/frida-android/build/build/sdk-android-arm/lib
 *
